...
class DataFetcherService:
    def __init__(self):
        ...
        self.stock_list_service = StockListService(provider=Providers.CUSTOM, cache=self.cache,
                                                   file_path=r"D:\PyPortWorkFlow\customData\EQUITY_L.csv")
    ...
    def get_close_price_service(self, ticker: str, start_date=None, end_date=None) -> pd.DataFrame:
        ...
        return self.close_price_service.get_data(ticker=ticker, start_date=start_date, end_date=end_date)
